  ...
  return (
    <div className="flex-1 bg-gray-50/50 min-h-full">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full">
        ...
        {/* ── AI Coach Tab ── */}
        <TabsContent value="coach" className="mt-0 p-6">
          <div className="max-w-3xl mx-auto">
        ...
        {/* ── Fees Tab ── */}
        <TabsContent value="fees" className="mt-0 p-6">
          <div className="max-w-3xl mx-auto">
            <TutorFees vidyaId={vidyaId} />
          </div>
        </TabsContent>
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent className="sm:max-w-md rounded-2xl">
          ...
          <form onSubmit={handleEditSave} className="space-y-4 mt-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-contact">{t("auth.emailOrPhone")}</Label>
              <Input
                id="edit-contact"
